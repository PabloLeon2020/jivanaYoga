...
<div class="header"> 
        ...
        <div class="header-inner">
                <div class="logo">
                		<?php skt_yogi_lite_the_custom_logo(); ?>
                 ...
                 <div class="headerright">
                    ...
                    <div class="toggle">
                <a class="toggleMenu" href="<?php echo esc_url('#');?>"><?php echo esc_attr('Menu','skt-yogi-lite'); ?></a>
                </div><!-- toggle -->
                <div class="nav">                  
...
<section id="home_slider">
        ...
        <?php echo esc_attr(__('Lee mas', 'skt-yogi-lite')); ?>
        </a> 
