...
<div id="footer-wrapper">
		...
		<?php } ?> 
                  ...
                  <div class="social-icons">
                    ...
                    <a title="twitter" class="tw" target="_blank" href="<?php echo esc_url(get_theme_mod('twitt_link','#instagram')); ?>"></a>
                    <?php } else { ?>
                    <?php echo '<a href="#" target="_blank" class="tw" title="instagram"></a>'; } ?> 
         ...
         <div class="copyright-wrapper">
            <div class="container">
            <div class="copyright-txt"><?php esc_attr_e('&copy; 2017');?> <?php bloginfo('name'); ?>. <?php esc_attr_e('Todos los derechos reservados');?> <?php printf('<a href="https://www.facebook.com/pabloleon.saracco" target="_blank">Pablo Saracco</a>' ); ?></div>
            </div>
		<div class="clear"></div>
</div>
    </div><!--end .footer-->
