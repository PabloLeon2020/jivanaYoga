...
function skt_yogi_lite_widgets_init() {	
	...
	register_sidebar( array(
		'name'          => __( 'Header Widget', 'skt-yogi-lite' ),
...
define('SKT_URL','http://www.sktthemes.net','skt-yogi-lite');
define('SKT_THEME_URL','http://www.sktthemes.net/themes/','skt-yogi-lite');
define('SKT_THEME_DOC','http://sktthemesdemo.net/documentation/skt-yogi-doc/','skt-yogi-lite');
define('SKT_PRO_THEME_URL','http://www.sktthemes.net/shop/yogi-yoga-wordpress-theme/','skt-yogi-lite');
define('SKT_PRO_FONT_AWESOME_URL','http://fortawesome.github.io/Font-Awesome/icons/','skt-yogi-lite');
define('SKT_FREE_THEME_URL','http://www.sktthemes.net/product-category/free-wordpress-themes/','skt-yogi-lite');
define('SKT_LIVE_DEMO','http://sktthemesdemo.net/yoga/','skt-yogi-lite');
...
if ( ! function_exists( 'skt_yogi_lite_the_custom_logo' ) ) :
/**
 ...
 *
 */
function skt_yogi_lite_the_custom_logo() {
...
function skt_yogi_lite_customizer_styles() {
    wp_enqueue_style( 'skt-yogi-lite-customizer', trailingslashit( get_template_directory_uri() ).'css/customizer.css', null );
}
add_action( 'customize_controls_print_styles', 'skt_yogi_lite_customizer_styles', 99 );